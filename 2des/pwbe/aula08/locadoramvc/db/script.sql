...
LOAD DATA INFILE 'D:/wellington/pessoal/arquivos/0_senai/2022_2des/vps01back/locadoramvc/db/clientes.csv'
INTO TABLE clientes
...
LOAD DATA INFILE 'D:/wellington/pessoal/arquivos/0_senai/2022_2des/vps01back/locadoramvc/db/filmes.csv'
INTO TABLE filmes
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
...
LOAD DATA INFILE 'D:/wellington/pessoal/arquivos/0_senai/2022_2des/vps01back/locadoramvc/db/locacoes.csv'
INTO TABLE locacoes
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
